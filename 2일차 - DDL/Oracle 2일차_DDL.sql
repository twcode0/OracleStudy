...
-- ALTER를 이용한 컬럼추가, 컬럼데이터타입수정, 컬럼명수정, 컬럼 삭제, 테이블명 수정
...
CREATE TABLE USER_FOREIGN_KEY(
    ...
    USER_DATE DATE DEFAULT SYSDATE, -- DEFAULT는 따로 ALTER를 만들지않음
    GRADE_CODE NUMBER
);
...
--04
ALTER TABLE USER_FOREIGN_KEY
RENAME COLUMN USER_DATE TO REWG_DATE;
